...
public class FileLogger extends FileLoggerConfiguration {
    ...
    public void recordFile() throws IOException {
        ...
        try (PrintWriter buf = new PrintWriter(new FileWriter(fileNam, true))) {
            ...
            } catch (hw_17.Exception.FileMaxSizeReachedException e) {
                File file = new File(fileNam);
                file.createNewFile();
            }

        } catch (IOException | hw_17.Exception.FileMaxSizeReachedException e) {
            throw new RuntimeException(e);
        }
    }

    public static void checkFileLength(String fileName) throws IOException, hw_17.Exception.FileMaxSizeReachedException { //проверка размера файла
